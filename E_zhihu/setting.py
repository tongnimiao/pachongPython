...
url = 'https://www.zhihu.com/api/v4/members/{user}?include=locations,educations'

followUrl = 'https://www.zhihu.com/api/v4/members/{user}/followees?include=data[*].answer_count,articles_count,gender,follower_count,is_followed,is_following,badge[?(type=best_answerer)].topics&offset={offset}&limit=20'
